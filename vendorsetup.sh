...
function _vendor_env_setup()
{
    ...
    [ -f $android_top_path/device/orangepi/common/version.txt ] && \
    source $android_top_path/device/orangepi/common/version.txt
...
function com()
{
    cd $android_top_path/device/orangepi/common
}
