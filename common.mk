DEVICE_PACKAGE_OVERLAYS := \
    device/orangepi/common/overlay/base

PRODUCT_COPY_FILES += \
    device/orangepi/common/init.common.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.common.rc \
    device/orangepi/common/init.ram.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.ram.rc \
...
PRODUCT_COPY_FILES += \
    device/orangepi/common/config/preloaded-classes:system/etc/preloaded-classes
...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.logd.kernel=true
else
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += \
...
$(eval $(shell awk '{print $$1}' device/orangepi/common/config/droidboost.version | grep DroidBoostVerison))
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += \
